          ...
          >
            <form @submit.prevent="handleSubmitForm">
              <div class="py-3 px-3 mb-3 CardReport">
                  <h1 class="text-center">เพิ่มรายการอบรม</h1>
              ...
              <div class="form-group mb-3 pt-3">
                <div class="d-flex justify-content-center">
                  <button class="btn btn-success btn-block">เพิ่มรายการอบรม</button>
                </div>
              </div>
...
export default {
  ...
  methods: {
    handleSubmitForm() {
      axios
        .post(`train`, this.train)
        .then((res) => {
          if(res.data.status == "ok"){
            /* alert("Create Train success"); */
          ...
          this.train = {
            ...
            closeForm: ""
              ...
              icon: 'success',
              title: 'Add Train Success',
              text: 'เพิ่มอบรมสำเร็จ!',
        ...
        this.$swal.fire({
          icon: 'error',
          title: 'Add Train Error!',
          text: 'เพิ่มอบรมไม่สำเร็จ',
        })
        .catch((error) => {
          console.log(error);
        });
